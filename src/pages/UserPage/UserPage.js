...
import { UserLogin } from "../../components/organism";
...
const ViewUser = () => {
  ...
  const openModal = () => {
    dispatch(modalSet({ active: true, page: "createUserLogin" }));
  };
  ...
  return (
    <Wrapper>
      <Title>
        <Tleft>
          User list ({filterData(users).length} of {users.length})
        </Tleft>
        <Tright>
